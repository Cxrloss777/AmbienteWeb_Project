  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="<?= BASE_URL ?>/dashboard/index" class="b-brand text-primary">
        <span class="text-white f-w-600" style="font-size: 22px; letter-spacing: 0.5px;">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-caption">
          <label>Pagos y Reservas</label>
          <i class="ph ph-currency-circle-dollar"></i>
        </li>
        <li class="pc-item">
          <a href="<?= BASE_URL ?>/pago/index" class="pc-link">
            <span class="pc-micon"><i class="ph ph-money"></i></span>
            <span class="pc-mtext">Pagos</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="<?= BASE_URL ?>/reserva/index" class="pc-link">
