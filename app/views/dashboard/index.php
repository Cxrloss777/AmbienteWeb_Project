        ...
        <div class="row">
          <div class="col-md-6 col-xl-3">
            <div class="card bg-grd-primary order-card">
              <div class="card-body">
                ...
                <h2 class="text-end text-white"><i class="feather icon-users float-start"></i><span><?= $residentesActivos ?></span> </h2>
                <p class="m-b-0">Unidades ocupadas<span class="float-end"><?= $unidadesOcupadas ?></span></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-xl-3">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1">
              <div class="card-body">
                <img src="<?= BASE_URL ?>/assets/images/widget/img-status-4.svg" alt="img" class="img-fluid img-bg" />
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1">
              <div class="card-body">
                <img src="<?= BASE_URL ?>/assets/images/widget/img-status-5.svg" alt="img" class="img-fluid img-bg" />
                <div class="d-flex align-items-center justify-content-between mb-3 drp-div">
          ...
          <div class="col-md-4 col-sm-12">
            <div class="card statistics-card-1 bg-brand-color-1">
              <div class="card-body">
                <img src="<?= BASE_URL ?>/assets/images/widget/img-status-6.svg" alt="img" class="img-fluid img-bg" />
                <div class="d-flex align-items-center justify-content-between mb-3 drp-div">
